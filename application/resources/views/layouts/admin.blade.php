            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() == 'admin-employee') active @endif" href="{{ url('/admin/employee') }}">
                                <i class="fas fa-users"></i><span class="text-with-icon">{{ __("Employee") }}</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() == 'admin-attendance') active @endif" href="{{ url('/admin/attendance') }}">
                                <i class="fas fa-list-alt"></i><span class="text-with-icon">{{ __("Attendance") }}</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() == 'admin-schedule') active @endif" href="{{ url('/admin/schedule') }}">
                                <i class="fas fa-calendar-alt"></i><span class="text-with-icon">{{ __("Schedule") }}</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() == 'admin-leave') active @endif" href="{{ url('/admin/leave') }}">
                                <i class="fas fa-calendar-day"></i><span class="text-with-icon">{{ __("Leave") }}</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link @if(Route::currentRouteName() == 'admin-reports') active @endif" href="{{ url('/admin/reports') }}">
                    ...
                    <ul class="navbar-nav ml-auto main-nav-top navmenu">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                <i class="fas fa-poll"></i><span class="text-with-icon text-uppercase">Manage</span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a href="{{ url('admin/company') }}" class="dropdown-item">
                                    <i class="fas fa-university"></i><span class="text-with-icon">{{ __("Company") }}</span>
                                </a>

                                <a href="{{ url('admin/department') }}" class="dropdown-item">
                                    <i class="fas fa-cubes"></i><span class="text-with-icon">{{ __("Department") }}</span>
                                </a>

                                <a href="{{ url('admin/jobtitle') }}" class="dropdown-item">
                                    <i class="fas fa-pencil-alt"></i><span class="text-with-icon">{{ __("Job Title") }}</span>
                                </a>

                                <a href="{{ url('admin/leavetype') }}" class="dropdown-item">
                                    <i class="fas fa-calendar-alt"></i><span class="text-with-icon">{{ __("Leave Type") }}</span>
                                </a>

                                <a href="{{ url('admin/leavegroups') }}" class="dropdown-item">
                                    <i class="fas fa-calendar-check"></i><span class="text-with-icon">{{ __("Leave Groups") }}</span>
                                </a>

                                <div class="line"></div>

                                <a href="{{ url('admin/users') }}" class="dropdown-item">
                                    <i class="fas fa-users"></i><span class="text-with-icon">{{ __("Users") }}</span>
                                </a>

                                <div class="line"></div>

                                <a href="{{ url('admin/settings') }}" class="dropdown-item">
                                    <i class="fas fa-cog"></i><span class="text-with-icon">{{ __("Settings") }}</span>
                                </a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{ url('/admin/account') }}">
                                    <i class="fas fa-user-tie"></i><span class="text-with-icon">{{ __("My Account") }}</span>
                                </a>

                                <a class="dropdown-item" href="{{ url('/personal/attendance') }}" target="_blank">
                                    <i class="fas fa-user-alt"></i><span class="text-with-icon">{{ __("Personal Portal") }}</span>
                                </a>
