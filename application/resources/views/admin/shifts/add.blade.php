...
@section('meta')
    <title>Add New Shift | Workday Time Clock</title>
    <meta name="description" content="Workday Add New Shift">
@endsection
...
<div class="container">
    ...
    <div class="card">
        <form action="{{ route('shift.store') }}" method="post" class="needs-validation" autocomplete="off" novalidate accept-charset="utf-8">
            @csrf
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="shift_name" value="{{old('shift_name')}}" class="form-control" required placeholder="Shift name">
                </div>
