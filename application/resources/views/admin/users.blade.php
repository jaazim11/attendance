            ...
            <table width="100%" class="table datatables-table custom-table-ui" data-order='[[ 0, "desc" ]]'>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <a href="{{ url('admin/users/edit') }}/{{ $data->id }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-pen"></i></a>
                            <a href="{{ url('admin/users/delete') }}/{{ $data->id }}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    @endisset
