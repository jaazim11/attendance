                ...
                <tbody>
                    ...
                    @foreach ($employees as $employee)
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ url('/admin/employee/view') }}/{{ $employee->reference }}" class="btn btn-outline-info btn-sm"><i class="fas fa-file-alt"></i></a>

                                <a href="{{ url('/admin/employee/edit') }}/{{ $employee->reference }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-pen"></i></a>

                                <a href="{{ url('/admin/employee/archive') }}/{{ $employee->reference }}" class="btn btn-outline-warning btn-sm"><i class="fas fa-archive"></i></a>

                                <a href="{{ url('/admin/employee/delete') }}/{{ $employee->reference }}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    @endisset
