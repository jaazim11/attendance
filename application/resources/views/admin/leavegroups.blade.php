                ...
                <tbody>
                    @isset($leavegroups) 
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <a href="{{ url('admin/leavegroups/edit') }}/{{ $lg->id }}" class="btn btn-outline-secondary btn-sm"><i class="fas fa-pen"></i></a>

                                <a href="{{ url('admin/leavegroups/delete') }}/{{ $lg->id }}" class="btn btn-outline-danger btn-sm"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    @endisset
